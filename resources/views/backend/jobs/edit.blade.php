...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <form id="job_submit_form" action="{{ route('backend.jobs.update', encrypt($job->id)) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                     @method('PUT')
                            ...
                            <div class="row formselector">
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="form-group select2form">
                                        ...
                                        <select class="select2 form-control block" id="select2-with-language"
                                            ...
                                            @php
                                            $selectedLanguages = old('languages', isset($job) ? $job->languages : []);
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="form-group select2form">
                                        ...
                                        <select class="select2 form-control block" id="select2-with-City" name="cities"
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="form-group">
                                        <label class="text-dark" for="title">Job Experience:<span class="text-danger">
                                                *</span></label>
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Position" name="position"
                                            value="{{ old('position',$job->position) }}" class="form-control typeText"
                                            required>
                                    </div>
                                    @error('position')
                                    <span class="text-danger">{{ $message }}</span>
                                                ...
                                                <div class="input-group">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" value="0" type="checkbox"
                                                            role="switch" id="hide_salary" name="hide_salary"
        ...
        if (country_id) {
            $.ajax({
                ...
                success: function(data) {
                    $('#select2-with-State').empty().append('<option value="">Select State</option>');
                    $.each(data, function(_, value) {
                        let isSelected = (value.id == oldState) ? 'selected' : '';
                        $('#select2-with-State').append('<option value="' + value.id + '" ' + isSelected + '>' + value.name + '</option>');
                    });
    ...
    function loadCities(state_id) {
        ...
        if (state_id) {
            $.ajax({
                ...
                dataType: "json",
                success: function(data) {
                    $('#select2-with-City').empty().append('<option value="">Select City</option>');
                    $.each(data, function(_, value) {
                        let isSelected = (value.id == oldCity) ? 'selected' : '';
                        $('#select2-with-City').append('<option value="' + value.id + '" ' + isSelected + '>' + value.name + '</option>');
                    });
                }
            });
        }
