    ...
    <div class="page-wrapper">
            ...
            <div class="col-12 mt-4 tabBN">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                      ...
                      <li class="nav-item" role="presentation">
                       ...
                       <li class="nav-item" role="presentation">
                          <button class="nav-link tabBTNs" id="pills-Job_shift" data-bs-toggle="pill" data-bs-target="#pills-shift"
                              type="button" role="tab" aria-controls="pills-shift" aria-selected="false">
                             Job Shifts 
                          </button>
                      </li>
      ...
      <div class="container-fluid pt-0">
        <!-- row --> 
                    ...
                    <div class="tab-pane fade show active" id="pills-candidates" role="tabpanel" aria-labelledby="pills-candidates-tab">
                          ...
                          <div class="row mb-4">  
                              <div class="col-12 d-flex justify-content-end gap-3 flex-wrap">
                                  <a href="{{ route('backend.jobs.create') }}" class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"  style="padding: 8px; max-width: 210px;">
                                                      ...
                                                      <td class="text-center d-flex justify-content-center"> 
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                    <li><a class="dropdown-item" href="#">Removed Featured</a></li> 
                                                                </ul>
                                                            </div>
                                                       ...
                                                       <td class="">
                                                        ...
                                                        <td class="d-flex justify-content-center"> 
                                                                  <span class="badge rounded-pill font-weight-medium bg-light-secondary text-secondary">9th Jun, 2025</span> 
                                                        </td> 

                                                      <td>
                                                            <div class=" d-flex justify-content-center">
                                                               <span class="badge rounded-pill font-weight-medium bg-light-info text-info ">20th Jun, 2025</span>
                                                            </div>
                                                      </td>
                                                      <td class="d-flex justify-content-center"> 
                                                         <span class=" badge font-weight-medium bg-light-warning text-warning">Super Admin</span>
                                                      </td> 
                                                      <td>
                                  ...
                                  <button 
                                    class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"
                                      style="padding: 8px; max-width: 210px;"
                                         data-bs-toggle="modal" data-bs-target="#JobCategories_add"
                                      >
                                          <i class="ri-add-line me-1"></i>
                                          <span> Add</span>
                                  </button> 
                                          ...
                                          <table class="table tableStyle mb-0 dataTable" id="zero_config_reported">
                                              ...
                                              <tbody>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="button--group d-flex justify-content-end">
                                                              <button class="btn btn-sm  editButtons" data-bs-toggle="modal" data-bs-target="#JobCategories_edit">
                                                                  <i class="ri-edit-box-line"></i> 
                                                              </button>
                                                              <button  class="btn btn-sm btn-outline--danger border-danger confirmationBtn delete_condidates" >
                                                                  <i class="ri-delete-bin-line"></i>
                         ...
                         <div class="row mb-4">  
                              <div class="col-12 d-flex justify-content-end gap-3 flex-wrap">
                                  <button 
                                    class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"
                                      style="padding: 8px; max-width: 210px;"
                                         data-bs-toggle="modal" data-bs-target="#Jobtype_add">
                                          <i class="ri-add-line me-1"></i>
                                          <span> Add</span>
                                  </button>  
                              </div> 
                                          ...
                                          <table class="table tableStyle mb-0 dataTable" id="zero_config_reported">
                                              ...
                                              <tbody>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="button--group d-flex justify-content-end">
                                                              <button class="btn btn-sm  editButtons" data-bs-toggle="modal" data-bs-target="#Jobtype_edit">
                                                                  <i class="ri-edit-box-line"></i> 
                                                              </button>
                                                              <button  class="btn btn-sm btn-outline--danger border-danger confirmationBtn delete_condidates" >
                                                                  <i class="ri-delete-bin-line"></i>
                          ...
                          <div class="row mb-4">  
                              <div class="col-12 d-flex justify-content-end gap-3 flex-wrap">
                                  <button 
                                    class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"
                                      style="padding: 8px; max-width: 210px;"
                                         data-bs-toggle="modal" data-bs-target="#JobTag_add">
                                          <i class="ri-add-line me-1"></i>
                                          <span> Add</span>
                                  </button>  
                              </div> 
                                              ...
                                              <tbody>
                                                  <tr>
                                                      ...
                                                      <td class="">
                                                        ...
                                                        <td class=" "> 
                                                                  Automated testing is the application of software tools to automate a human-driven manual process of reviewing and validating a software product. Most mode... 
                                                        </td>
                                                      <td>
                                                          <div class="button--group d-flex justify-content-end">
                                                              <button class="btn btn-sm  editButtons" data-bs-toggle="modal" data-bs-target="#JobTag_edit">
                                                                  <i class="ri-edit-box-line"></i> 
                                                              </button>
                                                              <button  class="btn btn-sm btn-outline--danger border-danger confirmationBtn delete_condidates" >
                                                                  <i class="ri-delete-bin-line"></i>
                          ...
                          <div class="row mb-4">  
                              <div class="col-12 d-flex justify-content-end gap-3 flex-wrap">
                                  <button 
                                    class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"
                                      style="padding: 8px; max-width: 210px;"
                                         data-bs-toggle="modal" data-bs-target="#JobShift_add">
                                          <i class="ri-add-line me-1"></i>
                                          <span> Add</span>
                                  </button>  
                              </div> 
                                          ...
                                          <table class="table tableStyle mb-0 dataTable" id="zero_config_reported">
                                              ...
                                              <tbody>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="button--group d-flex justify-content-end">
                                                              <button class="btn btn-sm  editButtons" data-bs-toggle="modal" data-bs-target="#JobShift_edit">
                                                                  <i class="ri-edit-box-line"></i> 
                                                              </button>
                                                              <button  class="btn btn-sm btn-outline--danger border-danger confirmationBtn delete_condidates" >
                                                                  <i class="ri-delete-bin-line"></i>
          ...
          <!--------------------modal start------------------->
        <!--  degree_add  -->
        <div class="modal fade" id="JobCategories_add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <!--  degree_edit  -->
        <div class="modal fade" id="JobCategories_edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
