                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active tabBTNs" id="pills-candidates-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-candidates" type="button" role="tab" aria-controls="pills-candidates"
                                aria-selected="true">
                                Jobs
                            </button>
                        </li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="">
                                                        <div class="form-check form-switch d-flex justify-content-center">
                                                            <input class="form-check-input job-status-toggle" type="checkbox"
                                                                role="switch" data-id="{{ encrypt($job->id) }}" {{ $job->status ? 'checked' : '' }} checked style="width: 2.5em;">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="button--group d-flex justify-content-end">
                                                            <a href="{{ route('backend.jobs.edit', encrypt($job->id)) }}" class="btn btn-sm  editButtons">
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            fetch(`/admin/jobs/status/update`, {
                                ...
                                body: JSON.stringify({ id: encryptedId, status: newStatus })
                            })
