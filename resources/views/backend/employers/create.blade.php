                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Company Name" name="emp_company"
                                            class="form-control typeText" value="{{ old('emp_company') }}"
                                            required>
                                        @error('emp_company')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectForm" id="select2-with-Size"
                                            ...
                                            <option value="100+" {{ old('company_size') == "100+" ? 'selected' : '' }}>
                                                100+</option>
                                        </select>
                                        @error('company_size')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="2nd Office Location" class="form-control"
                                            name="second_office_location" value="{{ old('second_office_location') }}">
                                ...
                                <div class="col-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <textarea id="editor" required
                                            name="employer_detail">{{ old('employer_detail') }}</textarea>
