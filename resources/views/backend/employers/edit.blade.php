...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row formselector">
            <div class="col-12">
                <form action="{{ route('backend.employer.update', Crypt::encrypt($employer->id)) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="row formselector">
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectForm" name="country" id="select2-with-Country"
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectForm" id="select2-with-State" name="state"
                                            style="width: 100%;">
   ...
   @foreach ($cities as $city)
        <option value="{{ $city->id }}" {{ old('city', $employer->user->city_id) == $city->id ? 'selected' : '' }}>
            {{ $city->name }}
        </option>
    @endforeach
                                        </select>
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectForm" id="select2-with-Size"
                                            ...
                                            <option value="1 - 10"
                                                {{ old('company_size', $employer->company_size) == "1 - 10" ? 'selected' : '' }}>1 - 10</option>
                                            <option value="10 - 50"
                                                {{ old('company_size',$employer->company_size) == "10 - 50" ? 'selected' : '' }}>10 - 50
                                            </option>
                                            <option value="50 - 100"
                                                {{ old('company_size',$employer->company_size) == "50 - 100" ? 'selected' : '' }}>50 - 100
                                            </option>
                                            <option value="100+" {{ old('company_size',$employer->company_size) == "100+" ? 'selected' : '' }}>
                                                100+</option>
                                        </select>
                                        @error('company_size')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Location" class="form-control" name="location"
                                            value="{{ old('location', $employer->location) }}" required>
                                        @error('location')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="2nd Office Location" class="form-control"
                                            name="second_office_location" value="{{ old('second_office_location',$employer->second_office_location) }}">
                                ...
                                <div class="col-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <textarea id="editor" required
                                            name="employer_detail">{{ old('employer_detail', $employer->employer_detail) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control " placeholder="https://www.facebook.com/"
                                                value="{{ old('facebook',$employer->facebook_url) }}" name="facbook" type="text">
                                            @error('facbook')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <label class="text-dark" for="title">Linkedin URL<span class="text-danger">
                                                *</span></label>
                                        <div class="input-group">
                                            <span class="input-grouptext"><i class="ri-linkedin-line"></i></span>
                                            <input class="form-control " placeholder="https://in.linkedin.com/"
                                                name="linkedin" value="{{ old('linkedin',$employer->linkedin_url) }}" type="text">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        $('#select2-with-State').append('<option value="' + value
