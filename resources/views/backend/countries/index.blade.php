...
@section('main-section')
    <div class="page-wrapper">
      ...
      <div class="container-fluid pt-0">
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="button--group d-flex justify-content-end">
                                                              <button class="btn btn-sm  editButtons" data-bs-toggle="modal" data-bs-target="#country_code_edit">
                                  ...
                                  <button 
                                    class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"
                                      style="padding: 8px; max-width: 210px;"
                                         data-bs-toggle="modal" data-bs-target="#state_add" >
                                              ...
                                              <tbody>
                                                @foreach($states as $state)
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="button--group d-flex justify-content-end">
                                                              <button class="btn btn-sm  editButtons" data-bs-toggle="modal" data-bs-target="#state_edit">
                                                                  <i class="ri-edit-box-line"></i> 
                                                              </button>
                                                              <button  class="btn btn-sm btn-outline--danger border-danger confirmationBtn delete_condidates" >
                                                                  <i class="ri-delete-bin-line"></i>
                            ...
                            <div class="row mb-4">  
                                <div class="col-12 d-flex justify-content-end gap-3 flex-wrap">
                                    <button 
                                        class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"
                                        style="padding: 8px; max-width: 210px;"
                                            data-bs-toggle="modal" data-bs-target="#city_add" >
                                            <i class="ri-add-line me-1"></i>
                                            <span> Add</span>
                                    </button> 
                                </div> 
          ...
          <!--------------------modal start------------------->
        <!--  country_add  -->
        <div class="modal fade" id="country_code_add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <!--  country_code_add  -->
        <div class="modal fade" id="country_code_edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
        ...
        <div class="modal fade parentModal" id="state_add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
        ...
        <!--  state  edit  -->
        <div class="modal fade parentModal" id="state_edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
        ...
        <!--  city edit  -->
        <div class="modal fade parentModal" id="city_edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
