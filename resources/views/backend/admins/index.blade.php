      ...
      <div class="page-titles">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 d-flex align-items-center">
                  <li class="breadcrumb-item">
                    <a href="{{ route('backend.admin.all_admins') }}" class="link"><i class="ri-home-3-line fs-5"></i></a>
                  </li>
          ...
          <div class="row mt-4"> 
              <div class="col-12 d-flex justify-content-end">
                   <a href="{{ route('backend.admin.create_admin') }}" class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"  style="padding: 8px; max-width: 220px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button--group d-flex justify-content-end">
                                            <a href="{{ route('backend.admin.edit_admin') }}" class="btn btn-sm  editButtons" >
