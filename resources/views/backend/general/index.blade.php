...
@section('main-section')
    <div class="page-wrapper">
      ...
      <div class="container-fluid pt-0">
                                  ...
                                  <button 
                                    class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"
                                      style="padding: 8px; max-width: 210px;"
                                         data-bs-toggle="modal" data-bs-target="#marital_Status_add">
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="button--group d-flex justify-content-end">
                                                              <button class="btn btn-sm  editButtons" data-bs-toggle="modal" data-bs-target="#marital_Status_edit">
                          ...
                          <div class="row mb-4">  
                              <div class="col-12 d-flex justify-content-end gap-3 flex-wrap">
                                  <button 
                                    class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"
                                      style="padding: 8px; max-width: 210px;"
                                         data-bs-toggle="modal" data-bs-target="#salary_periods_add">
                                          <i class="ri-add-line me-1"></i>
                                          <span> Add</span>
                                  </button>  
                              </div> 
                                          ...
                                          <table class="table tableStyle mb-0 dataTable" id="zero_config_reported">
                                              ...
                                              <tbody>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="button--group d-flex justify-content-end">
                                                              <button class="btn btn-sm  editButtons" data-bs-toggle="modal" data-bs-target="#salary_periods_edit">
                                                                  <i class="ri-edit-box-line"></i> 
                                                              </button>
                                                              <button  class="btn btn-sm btn-outline--danger border-danger confirmationBtn delete_condidates" >
                                                                  <i class="ri-delete-bin-line"></i>
                          ...
                          <div class="row mb-4">  
                              <div class="col-12 d-flex justify-content-end gap-3 flex-wrap">
                                  <button 
                                    class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"
                                      style="padding: 8px; max-width: 210px;"
                                         data-bs-toggle="modal" data-bs-target="#Industries_add">
                                          <i class="ri-add-line me-1"></i>
                                          <span> Add</span>
                                  </button>  
                              </div> 
                                          ...
                                          <table class="table tableStyle mb-0 dataTable" id="zero_config_reported">
                                              ...
                                              <tbody>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="button--group d-flex justify-content-end">
                                                              <button class="btn btn-sm  editButtons" data-bs-toggle="modal" data-bs-target="#Industries_edit">
                                                                  <i class="ri-edit-box-line"></i> 
                                                              </button>
                                                              <button  class="btn btn-sm btn-outline--danger border-danger confirmationBtn delete_condidates" >
                                                                  <i class="ri-delete-bin-line"></i>
                          ...
                          <div class="row mb-4">  
                              <div class="col-12 d-flex justify-content-end gap-3 flex-wrap">
                                  <button 
                                    class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"
                                      style="padding: 8px; max-width: 210px;"
                                         data-bs-toggle="modal" data-bs-target="#company_size_add">
                                          <i class="ri-add-line me-1"></i>
                                          <span> Add</span>
                                  </button>  
                              </div> 
                                          ...
                                          <table class="table tableStyle mb-0 dataTable" id="zero_config_reported">
                                              ...
                                              <tbody>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="button--group d-flex justify-content-end">
                                                              <button class="btn btn-sm  editButtons" data-bs-toggle="modal" data-bs-target="#company_size_edit">
                                                                  <i class="ri-edit-box-line"></i> 
                                                              </button>
                                                              <button  class="btn btn-sm btn-outline--danger border-danger confirmationBtn delete_condidates" >
                                                                  <i class="ri-delete-bin-line"></i>
                          ...
                          <div class="row mb-4">  
                              <div class="col-12 d-flex justify-content-end gap-3 flex-wrap">
                                  <button 
                                    class="btn btn-sm d-flex align-items-center justify-content-center m-0 w-100 addButton"
                                      style="padding: 8px; max-width: 210px;"
                                         data-bs-toggle="modal" data-bs-target="#functianal_add">
                                          <i class="ri-add-line me-1"></i>
                                          <span> Add</span>
                                  </button>  
                              </div> 
                                          ...
                                          <table class="table tableStyle mb-0 dataTable" id="zero_config_reported">
                                              ...
                                              <tbody>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="button--group d-flex justify-content-end">
                                                              <button class="btn btn-sm  editButtons" data-bs-toggle="modal" data-bs-target="#functianal_edit">
                                                                  <i class="ri-edit-box-line"></i> 
                                                              </button>
                                                              <button  class="btn btn-sm btn-outline--danger border-danger confirmationBtn delete_condidates" >
                                                                  <i class="ri-delete-bin-line"></i>
          ...
          <!--------------------modal start------------------->
        <!--  New Marital Status  -->
        <div class="modal fade" id="marital_Status_add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <!--  edit Marital Status  -->
        <div class="modal fade" id="marital_Status_edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
        ...
        <div class="modal fade" id="salary_periods_add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
        ...
        <!--  Edit Salary Period  -->
        <div class="modal fade" id="salary_periods_edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
