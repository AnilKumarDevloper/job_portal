                                ...
                                <div class="row formselector">
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group"> 
                                            ...
                                            <input type="text" name="first_name" placeholder="First Name" class="form-control typeText" value="{{ $condidate->first_name }}"> 
                                            @error('first_name')
                                     ...
                                     <div class="col-md-4 mb-4">
                                        <div class="form-group"> 
                                            ...
                                            <input type="text" name="last_name" placeholder="Last Name" class="form-control typeText" value="{{ $condidate->last_name }}"> 
                                            @error('last_name')
                                                <p style="color:red">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group"> 
                                            ...
                                            <input type="email" name="email" placeholder="Email" class="form-control" value="{{ $condidate->email }}"> 
                                            @error('email')
                                                <p style="color:red">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group"> 
                                            ...
                                            <input type="text" name="father_name" placeholder="Father Name" class="form-control typeText" value="{{ $condidate->getCondidateDetail->father_name}}"> 
                                            @error('father_name')
                                                <p style="color:red">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group"> 
                                            ...
                                            <input type="date" name="date_of_birth" placeholder="Birth Date" class="form-control" value="{{ Carbon\Carbon::parse($condidate->getCondidateDetail->date_of_birth)->format('Y-m-d') }}" max="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"> 
                                             @error('date_of_birth')
                                                <p style="color:red">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group select2form"> 
                                            ...
                                            <select class="select2 form-control block selectForm" name="skills[]" id="skills" multiple="multiple" style="width: 100%">
                                                ...
                                                <option value="HTML" {{ in_array('HTML', $condidate->getCondidateDetail->skills) ? 'selected' : '' }}>HTML</option>
                                                <option value="CSS" {{ in_array('CSS', $condidate->getCondidateDetail->skills) ? 'selected' : '' }}>CSS</option>
                                                <option value="Javascript" {{ in_array('Javascript', $condidate->getCondidateDetail->skills) ? 'selected' : '' }}>Javascript</option>
                                                <option value="Jquery" {{ in_array('Jquery', $condidate->getCondidateDetail->skills) ? 'selected' : '' }}>Jquery</option>
                                            </select>
                                               @error('sikills')
                                                <p style="color:red">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group select2form"> 
                                            ...
                                            <select class="select2 form-control block" name="languages[]" id="languages" multiple="multiple" style="width: 100%" >
                                                <option value="english" {{ in_array('english', $condidate->getCondidateDetail->language) ? 'selected' : '' }}>English</option>
                                                <option value="hindi" {{ in_array('hindi', $condidate->getCondidateDetail->language) ? 'selected' : '' }}>Hindi</option> 
                                            </select>
                                            @error('languages')
                                                <p style="color:red">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group"> 
                                            ...
                                            <select class="form-control selectForm" name="marital_status" id="marital_status" style="width: 100%;">
                                                    ...
                                                    <option value="Single" {{ $condidate->getCondidateDetail->marital_status == 'Single' ? 'selected' : '' }}>Single</option>  
                                                    <option value="Married" {{ $condidate->getCondidateDetail->marital_status == 'Married' ? 'selected' : '' }}>Married</option>  
                                            </select>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group"> 
                                            ...
                                            <input type="text" name="nationality" placeholder="Nationality" class="form-control typeText" value="{{ $condidate->getCondidateDetail->nationality }}"> 
                                            @error('nationality')
                                                <p style="color:red">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group"> 
                                            ...
                                            <input type="text" name="national_id_card" placeholder="National ID Card" class="form-control text-uppercase" maxlength="12" value="{{ $condidate->getCondidateDetail->national_id_card }}"> 
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group"> 
                                            ...
                                            <select class="form-control selectForm" name="country" id="country" style="width: 100%;">
                                                    <option value="">--Select--</option>
                                                    <option value="India" {{ $condidate->country == 'India' ? 'selected' : '' }}>India</option>  
                                                    <option value="Australia" {{ $condidate->country == 'Australia' ? 'selected' : '' }}>Australia</option>  
                                                    <option value="America" {{ $condidate->country == 'America' ? 'selected' : '' }}>America</option>  
                                            </select>
                                            @error('country')
                                                <p style="color:red">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group"> 
                                                ...
                                                <select class="form-control selectForm" name="state" id="state" style="width: 100%;">
                                                    <option value="">--Select--</option>
                                                    <option valu="Uttar Pradesh" {{ $condidate->state == 'Uttar Pradesh' ? 'selected' : '' }}>Uttar Pradesh</option>  
                                                </select>
                                                @error('state')
                                                    <p style="color:red">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group"> 
                                                ...
                                                <select class="form-control selectForm" name="city" id="city" style="width: 100%;">
                                                   <option value="">--Select--</option>
                                                    <option value="New Delhi" {{ $condidate->city == 'New Delhi' ? 'selected' : '' }}>New Delhi</option>  
                                                </select>
                                                @error('city')
                                                    <p style="color:red">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group"> 
                                                ...
                                                <input type="number" name="phone" placeholder="Mobile Number" class="form-control typeNumber" value="{{ $condidate->phone }}"> 
                                                 @error('phone')
                                                    <p style="color:red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group"> 
                                                ...
                                                <input type="number" name="experience_in_year" placeholder="Experience: (In Years)" class="form-control yearExp" value="{{ $condidate->getCondidateDetail->experience }}"> 
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group"> 
                                                ...
                                                <select class="form-control selectForm" name="career_level" id="career_level" style="width: 100%;">
                                                       <option value="">--Select--</option>
                                                        <option value="Developer" {{ $condidate->getCondidateDetail->career_level  == 'Developer' ? 'selected' : '' }}>Developer</option>   
                                                </select>
                                                @error('career_level')
                                                    <p style="color:red">{{ $message }}</p>
                                                @enderror
                                         ...
                                         <div class="col-md-4 mb-4">
                                            <div class="form-group"> 
                                                ...
                                                <select class="form-control selectForm" name="functional_area" id="functional_area" style="width: 100%;">
                                                        <option value="">--Select--</option>
                                                        <option value="ABC" {{ $condidate->getCondidateDetail->functional_area == 'ABC' ? 'selected' : '' }}>ABC</option>  
                                                </select>
                                                @error('career_level')
                                                    <p style="color:red">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group"> 
                                                ...
                                                <input type="number" name="current_salary" placeholder="Current Salary" class="form-control" value="{{ $condidate->getCondidateDetail->current_salary }}"> 
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group"> 
                                                ...
                                                <input type="number" name="expected_salary" placeholder="Expected Salary" class="form-control" value="{{ $condidate->getCondidateDetail->expected_salary }}"> 
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control bg-white" name="salary_currency" id="salary_currency">
                                                    <option value="">--Select--</option>
                                                    <option value="INR" {{ $condidate->getCondidateDetail->salary_currency == 'INR' ? 'selected' : '' }}>INR</option>  
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-4">
                                           <div class="form-group"> 
                                               ...
                                               <div class="input-group">
                                                   ...
                                                   <input class="form-control" name="facebook_url" placeholder="https://www.facebook.com/" type="text" value="{{ $condidate->getCondidateDetail->facebook_url }}">
                                                </div>
                                                  @error('facebook_url')
                                                        <p style="color:red">{{ $message }}</p>
                                                 @enderror
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="form-group"> 
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" name="linkedin_url" placeholder="https://in.linkedin.com/" type="text" value="{{ $condidate->getCondidateDetail->linkedin_url }}">  
                                                </div>
                                                    @error('linkedin_url')
                                                        <p style="color:red">{{ $message }}</p>
                                                    @enderror
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="form-group"> 
                                                ...
                                                <input class="form-control" name="available_at" placeholder="Available At" type="date" value="{{ Carbon\Carbon::parse($condidate->getCondidateDetail->available_at)->format('Y-m-d') }}" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
                                                @error('available_at')
                                                    <p style="color:red">{{ $message }}</p>
                                                @enderror
                                            </div>
