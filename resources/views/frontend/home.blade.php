                    ...
                    <div class="row mt-4" >
                        ...
                        <div class="col-lg-6">
                                        ...
                                        <div class="tabs_job">
                                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist"> 
                                                    <li class="nav-item" role="presentation">
                                                        ...
                                                        type="button" role="tab" aria-controls="pills-profile" aria-selected="true">Profile (21)</button>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link" id="pills-tab2-tab" data-bs-toggle="pill" 
                                                        data-bs-target="#pills-tab2" type="button" role="tab" aria-controls="pills-tab2" 
                                                        aria-selected="false">Applies (124)</button>
                                                    </li> 
                                                </ul>
                                                                    ...
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                            <a href="applyJob.html" class="text-decoration-none text-black">
                                                                                ...
                                                                                <p class="job_address m-0 mt-2"><i class="ri-map-pin-line"></i>  Delhi..</p>
                         ...
                         <div class="col-lg-3 sticky-top" style="top: 0;"> 
                               ...
                               <div class="card sticky-top" style="top: 70px;">
                                    <img src="https://media.istockphoto.com/id/1413735503/photo/social-media-social-media-marketing-thailand-social-media-engagement-post-structure.jpg?s=612x612&w=0&k=20&c=7Y4Bdom9c7paYa67nSCvwSuFoppYxJIh-CTYqe6J4Js=" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <!-- <h5 class="card-title">Card title</h5> -->
                                        <p class="company">Some quick example text to build on the card title and make up the bulk of the card’s content.</p>
